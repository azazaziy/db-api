...
#             }
#     }
#     article_id = db-api.execute(**s_one)
#     if article_id:
#         return {"error": 'existed_login'}
#     else:
#         resp = db-api.execute(**response)
#         return{'resp': resp}
#
# @app.get('/login')
# async def login(
...
#     db-api.execute(**article.as_dict())
